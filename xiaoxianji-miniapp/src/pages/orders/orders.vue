...
.order-item-price { font-size:var(--font-base); color:var(--color-text-1); font-weight:600; }
...
.order-btn { padding:10rpx 24rpx; border-radius:var(--radius-xl); font-size:var(--font-sm); font-weight:600; }
...
.phone-auth-btn { width:100%; background:var(--color-primary); color:#fff; border-radius:var(--radius-xl); font-size:var(--font-base); font-weight:600; padding:18rpx 0; text-align:center; border:none; }
